/**
 * Outcome marks for the issuance dialog. These replace ✅ / ⚠️ emoji, which
 * change shape and colour per platform and cannot inherit the surface they sit
 * on. Both draw in currentColor.
 */
